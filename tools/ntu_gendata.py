...
def gendata(data_path,
    ...
    for i, s in enumerate(sample_name):
        ...
        data = read_xyz(
            os.path.join(data, s), max_body=max_body, num_joint=num_joint
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ignored_sample_path', default='resource/NTU-RGB-D/samples_with_missing_skeletons.txt')
